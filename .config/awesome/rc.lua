...
mytextclock = wibox.widget.textclock('%l:%M %p %B %d, %Y')
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey   }, "=",
               function() 
                 ...
                 tag.gap = tag.gap - tag_change_amount
               end,
              {description = "Increase the space between windows", group = "client"}),
    awful.key({ modkey   }, "-", 
               function() 
                 local screen = awful.screen.focused()
                 local tag = screen.selected_tag
              ...
              {description = "Decrease the space between windows", group = "client"}),
    awful.key({ modkey   }, "0", 
               function() 
                 local screen = awful.screen.focused()
                 local tag = screen.selected_tag
              ...
              {description = "Erase the gaps between windows", group = "client"}),
